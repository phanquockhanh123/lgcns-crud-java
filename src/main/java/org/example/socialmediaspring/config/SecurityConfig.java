...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request.requestMatchers("/api/v1/auth/**", "/api/v1/public/**", "/static/public/**","/ws/**", "/topic/**", "/js/**", "/swagger-ui.html", "/swagger-ui/*", "/v2/api-docs", "/actuator/**", "/explorer/**").permitAll()
