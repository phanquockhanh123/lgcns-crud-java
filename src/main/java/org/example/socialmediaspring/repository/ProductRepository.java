...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query(value = "SELECT new org.example.socialmediaspring.dto.product.ProductDto(p.id, p.title, p.description, p.price, p.discountPercentage," +
            ...
            " p.thumbnail, c.name)  FROM Product p " +
